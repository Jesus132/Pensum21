...
class Pensum : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        materias[0].setOnClickListener {
            matb[0] = EstadoonClick(matb[0], blanco[0], verde[0], azul[0], rojo[0], materias[0])
        }

        materias[1].setOnClickListener {
            matb[1] = EstadoonClick(matb[1], blanco[1], verde[1], azul[1], rojo[1], materias[1])
        }

        materias[2].setOnClickListener {
            matb[2] = EstadoonClick(matb[2], blanco[2], verde[2], azul[2], rojo[2], materias[2])
        }

        materias[3].setOnClickListener {
            matb[3] = EstadoonClick(matb[3], blanco[3], verde[3], azul[3], rojo[3], materias[3])
        }

        materias[4].setOnClickListener {
            matb[4] = EstadoonClick(matb[4], blanco[4], verde[4], azul[4], rojo[4], materias[4])
        }

        materias[5].setOnClickListener {
            matb[5] = EstadoonClick(matb[5], blanco[5], verde[5], azul[5], rojo[5], materias[5])
        }

        materias[6].setOnClickListener {
            matb[6] = EstadoonClick(matb[6], blanco[6], verde[6], azul[6], rojo[6], materias[6])
        }

        materias[7].setOnClickListener {
            matb[7] = EstadoonClick(matb[7], blanco[7], verde[7], azul[7], rojo[7], materias[7])
        }

        materias[8].setOnClickListener {
            matb[8] = EstadoonClick(matb[8], blanco[8], verde[8], azul[8], rojo[8], materias[8])
        }

        materias[9].setOnClickListener {
            matb[9] = EstadoonClick(matb[9], blanco[9], verde[9], azul[9], rojo[9], materias[9])
        }

        materias[10].setOnClickListener {
            matb[10] = EstadoonClick(matb[10], blanco[10], verde[10], azul[10], rojo[10], materias[10])
        }

        materias[11].setOnClickListener {
            matb[11] = EstadoonClick(matb[11], blanco[11], verde[11], azul[11], rojo[11], materias[11])
        }

        materias[12].setOnClickListener {
            matb[12] = EstadoonClick(matb[12], blanco[12], verde[12], azul[12], rojo[12], materias[12])
        }

        materias[13].setOnClickListener {
            matb[13] = EstadoonClick(matb[13], blanco[13], verde[13], azul[13], rojo[13], materias[13])
        }

        materias[14].setOnClickListener {
            matb[14] = EstadoonClick(matb[14], blanco[14], verde[14], azul[14], rojo[14], materias[14])
        }

        materias[15].setOnClickListener {
            matb[15] = EstadoonClick(matb[15], blanco[15], verde[15], azul[15], rojo[15], materias[15])
        }

        materias[16].setOnClickListener {
            matb[16] = EstadoonClick(matb[16], blanco[16], verde[16], azul[16], rojo[16], materias[16])
        }

        materias[17].setOnClickListener {
            matb[17] = EstadoonClick(matb[17], blanco[17], verde[17], azul[17], rojo[17], materias[17])
        }

        materias[18].setOnClickListener {
            matb[18] = EstadoonClick(matb[18], blanco[18], verde[18], azul[18], rojo[18], materias[18])
        }

        materias[19].setOnClickListener {
            matb[19] = EstadoonClick(matb[19], blanco[19], verde[19], azul[19], rojo[19], materias[19])
        }

        materias[20].setOnClickListener {
            matb[20] = EstadoonClick(matb[20], blanco[20], verde[20], azul[20], rojo[20], materias[20])
        }

        materias[21].setOnClickListener {
            matb[21] = EstadoonClick(matb[21], blanco[21], verde[21], azul[21], rojo[21], materias[21])
        }

        materias[22].setOnClickListener {
            matb[22] = EstadoonClick(matb[22], blanco[22], verde[22], azul[22], rojo[22], materias[22])
        }

        materias[23].setOnClickListener {
            matb[23] = EstadoonClick(matb[23], blanco[23], verde[23], azul[23], rojo[23], materias[23])
        }

        materias[24].setOnClickListener {
            matb[24] = EstadoonClick(matb[24], blanco[24], verde[24], azul[24], rojo[24], materias[24])
        }

        materias[25].setOnClickListener {
            matb[25] = EstadoonClick(matb[25], blanco[25], verde[25], azul[25], rojo[25], materias[25])
        }

        materias[26].setOnClickListener {
            matb[26] = EstadoonClick(matb[26], blanco[26], verde[26], azul[26], rojo[26], materias[26])
        }

        materias[27].setOnClickListener {
            matb[27] = EstadoonClick(matb[27], blanco[27], verde[27], azul[27], rojo[27], materias[27])
        }

        materias[28].setOnClickListener {
            matb[28] = EstadoonClick(matb[28], blanco[28], verde[28], azul[28], rojo[28], materias[28])
        }

        materias[29].setOnClickListener {
            matb[29] = EstadoonClick(matb[29], blanco[29], verde[29], azul[29], rojo[29], materias[29])
        }

        materias[30].setOnClickListener {
            matb[30] = EstadoonClick(matb[30], blanco[30], verde[30], azul[30], rojo[30], materias[30])
        }

        materias[31].setOnClickListener {
            matb[31] = EstadoonClick(matb[31], blanco[31], verde[31], azul[31], rojo[31], materias[31])
        }

        materias[32].setOnClickListener {
            matb[32] = EstadoonClick(matb[32], blanco[32], verde[32], azul[32], rojo[32], materias[32])
        }

        materias[33].setOnClickListener {
            matb[33] = EstadoonClick(matb[33], blanco[33], verde[33], azul[33], rojo[33], materias[33])
        }

        materias[34].setOnClickListener {
            matb[34] = EstadoonClick(matb[34], blanco[34], verde[34], azul[34], rojo[34], materias[34])
        }

        materias[35].setOnClickListener {
            matb[35] = EstadoonClick(matb[35], blanco[35], verde[35], azul[35], rojo[35], materias[35])
        }

        materias[36].setOnClickListener {
            matb[36] = EstadoonClick(matb[36], blanco[36], verde[36], azul[36], rojo[36], materias[36])
        }

        materias[37].setOnClickListener {
            matb[37] = EstadoonClick(matb[37], blanco[37], verde[37], azul[37], rojo[37], materias[37])
        }

        materias[38].setOnClickListener {
            matb[38] = EstadoonClick(matb[38], blanco[38], verde[38], azul[38], rojo[38], materias[38])
        }

        materias[39].setOnClickListener {
            matb[39] = EstadoonClick(matb[39], blanco[39], verde[39], azul[39], rojo[39], materias[39])
        }

        materias[40].setOnClickListener {
            matb[40] = EstadoonClick(matb[40], blanco[40], verde[40], azul[40], rojo[40], materias[40])
        }

        materias[41].setOnClickListener {
            matb[41] = EstadoonClick(matb[41], blanco[41], verde[41], azul[41], rojo[41], materias[41])
        }

        materias[42].setOnClickListener {
            matb[42] = EstadoonClick(matb[42], blanco[42], verde[42], azul[42], rojo[42], materias[42])
        }

        materias[43].setOnClickListener {
            matb[43] = EstadoonClick(matb[43], blanco[43], verde[43], azul[43], rojo[43], materias[43])
        }

        materias[44].setOnClickListener {
            matb[44] = EstadoonClick(matb[44], blanco[44], verde[44], azul[44], rojo[44], materias[44])
        }

        materias[45].setOnClickListener {
            matb[45] = EstadoonClick(matb[45], blanco[45], verde[45], azul[45], rojo[45], materias[45])
        }

        materias[46].setOnClickListener {
            matb[46] = EstadoonClick(matb[46], blanco[46], verde[46], azul[46], rojo[46], materias[46])
        }

        materias[47].setOnClickListener {
            matb[47] = EstadoonClick(matb[47], blanco[47], verde[47], azul[47], rojo[47], materias[47])
        }

        materias[48].setOnClickListener {
            matb[48] = EstadoonClick(matb[48], blanco[48], verde[48], azul[48], rojo[48], materias[48])
        }

        materias[49].setOnClickListener {
            matb[49] = EstadoonClick(matb[49], blanco[49], verde[49], azul[49], rojo[49], materias[49])
        }
        ...
        materias[2].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[3].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[4].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[5].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[6].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[7].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[8].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[9].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[10].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[11].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[12].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[13].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[14].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[15].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[16].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[17].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[18].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[19].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[20].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[21].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[22].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[23].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[24].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[25].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[26].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[27].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[28].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[29].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[30].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[31].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[32].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[33].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[34].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[35].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[36].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[37].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
            intent.putExtra("MATERIA", "Electiva de Humanidades")
            startActivity(intent)
            true
        ...
        materias[38].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[39].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[40].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[41].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[42].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
            intent.putExtra("MATERIA", "Electiva De Ingenieria")
            startActivity(intent)
            true
        ...
        materias[43].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
            intent.putExtra("MATERIA", "Electiva De Humanidades")
            startActivity(intent)
            true
        ...
        materias[44].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[45].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
            intent.putExtra("MATERIA", "Electiva De Ingenieria")
            startActivity(intent)
            true
        ...
        materias[46].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
            intent.putExtra("MATERIA", "Electiva De Ingenieria")
            startActivity(intent)
            true
        ...
        materias[47].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[48].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
        ...
        materias[49].setOnLongClickListener {
            val intent: Intent = Intent(this, Recordatorios::class.java)
            intent.putExtra("MATERIA", "Electiva de Ingenieria")
            startActivity(intent)
            true
    ...
    fun EstadoonClick(matb: Char, blanco: Int, verde: Int,azul: Int, rojo: Int, matr: View): Char{
        var matb = matb
        if (matb == '3') {
